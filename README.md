...
```bash
sudo apt install -y git && git clone https://github.com/pgdigital/instalador_automysql.git instalador && sudo chmod -R 777 ./instalador && cd ./instalador && sudo ./install_primaria
```
